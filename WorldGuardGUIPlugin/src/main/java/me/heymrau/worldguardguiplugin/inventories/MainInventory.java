...
public class MainInventory {
    ...
    public void open(Player player, String regionName) {
        ...
        GuiItem renameItem = ItemBuilder.from(Material.NAME_TAG)
                ...
                .lore(Component.empty(), Utils.colored("&7Active name: &a" + regionName))
                .asGuiItem((event) -> {
                    player.closeInventory();
        ...
        GuiItem saveTemplateItem = ItemBuilder.from(Material.GOLD_INGOT)
                ...
                .asGuiItem((event) -> {
                    ...
                    plugin.getTemplateManager()
                            .addTemplate(new Template(regionName, plugin.getWorldGuard()
        ...
        GuiItem deleteItem = ItemBuilder.from(Material.BARRIER)
                .name(Utils.colored("&cDelete region " + regionName))
                .asGuiItem((event) -> new ConfirmationInventory().open(player, (confirmationPlayer) -> {
